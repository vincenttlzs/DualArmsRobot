...
class shuang_reset(object):
    ...
    def __init__(self):
        ...
        self.r_arm_commander = MoveGroupCommander("r_arm")
        self.l_arm_commander = MoveGroupCommander("l_arm")

        self.hand_commander = MoveGroupCommander("r_gripper")
        
 #       self.__hand_traj_client = SimpleActionClient("/r_arm_controller/follow_joint_trajectory", 
        #                                             FollowJointTrajectoryAction)
 #       self.__arm_traj_client = SimpleActionClient("/l_arm_controller/follow_joint_trajectory", 
       #                                             FollowJointTrajectoryAction)
   ...
   #         raise Exception("Failed to connect to /arm_controller/follow_joint_trajectory in 4sec.")
    ...
    def reset_world(self):
        ...
        self.__switch_ctrl.call(start_controllers=[], 
                                stop_controllers=["r_arm_controller", "l_arm_controller", "joint_state_controller", "l_gripper_controller", "r_gripper_controller"], 
                                strictness=SwitchControllerRequest.BEST_EFFORT)
        self.__pause_physics.call()
        
        joint_names = ['base_r_1_joint', 'r_1_r_2_joint', 'r_2_r_3_join', 'r_3_r_4_joint', 'r_4_r_5_joint', 'r_arm_wrist_flex_joint', 'r_gripper_finger_joint', 'base_l_1_joint', 'l_1_l_2_joint', 'l_2_l_3_join', 'l_3_l_4_joint', 'l_4_l_5_joint', 'l_arm_wrist_flex_joint', 'l_gripper_finger_joint', ]

        joint_positions = [0, -2.25, 0, 0, 0, 0, 0, -2.25, 0, 0, 0, 0, 0, 0]
        
        self.__set_model.call(model_name="shuang_all", 
