...
class MoveItDemo:
    def __init__(self):
        ...
        # Connect to the r_arm move group
        ...
        r_arm.set_pose_reference_frame('base_footprint')
                
        # Allow some leeway in position(meters) and orientation (radians)
        r_arm.set_goal_position_tolerance(0.8)
        r_arm.set_goal_orientation_tolerance(0.8)
        ...
        wpose.position.x = 0.119221   #-0.859347 -0.740126	
        wpose.position.y = 0.094571  #0.248856  0.263427
        ...
        if cartesian:
            ...
            r_arm.set_pose_target(start_pose)
            r_arm.go()
            rospy.sleep(1)
