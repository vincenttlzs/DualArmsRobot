...
class MoveItDemo:
    def __init__(self):
        ...
        r_arm.set_goal_position_tolerance(0.005)
      ...
      #  rospy.sleep(1)
        ...
        target_pose.pose.position.x = -0.486072
        target_pose.pose.position.y = 0.031178
        target_pose.pose.position.z = 0.737335
        target_pose.pose.orientation.x = -0.025261 
        target_pose.pose.orientation.y = -0.0557766
        target_pose.pose.orientation.z = 0.687875
        target_pose.pose.orientation.w = 0.723149
