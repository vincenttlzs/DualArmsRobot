...
class MoveItDemo:
    def __init__(self):
        ...
        r_arm = MoveGroupCommander(GROUP_NAME_ARM)
        ...
        r_arm.set_goal_position_tolerance(0.5)
        r_arm.set_goal_orientation_tolerance(0.9)
...
###############################################################   
        ...
        target_pose.pose.position.x = -0.716839
        target_pose.pose.position.y = 0.026581
        target_pose.pose.position.z = 0.827 #table_ground + table_size[2] + target_radius
        target_pose.pose.orientation.w = 1.0
        
        # Add the target object to the scene
        scene.add_sphere(target_id, target_pose, target_radius)
        ...
        r_arm.set_support_surface_name(table_id)
        
        # Specify a pose to place the target after being picked up
        place_pose = PoseStamped()
        place_pose.header.frame_id = REFERENCE_FRAME
        place_pose.pose.position.x = -0.68
        place_pose.pose.position.y = -0.18
        place_pose.pose.position.z = table_ground + table_size[2] + target_radius / 2.0
        ...
        grasp_pose.pose.position.x = -0.716839
        grasp_pose.pose.position.y = 0.026581 - 0.02 / 2.0
        grasp_pose.pose.position.z = 0.827 #table_ground + table_size[2] + target_radius
        grasp_pose.pose.orientation.w = 1.0
        
        # Shift the grasp pose by half the width of the target to center it
        #grasp_pose.pose.position.y -= 0.02 / 2.0
        ...
        while result != MoveItErrorCodes.SUCCESS and n_attempts < max_pick_attempts:
            ...
            result = r_arm.pick(target_id, grasps)
            rospy.sleep(0.2)
        ...
        if result == MoveItErrorCodes.SUCCESS:
            ...
            while result != MoveItErrorCodes.SUCCESS and n_attempts < max_place_attempts:
                ...
                for place in places:
                    result = r_arm.place(target_id, place)
                    if result == MoveItErrorCodes.SUCCESS:
                        break
                rospy.sleep(0.2)
