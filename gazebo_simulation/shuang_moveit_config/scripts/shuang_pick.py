...
###########################################
        ...
        target_pose.pose.position.x = -0.606674
        target_pose.pose.position.y = 0.553603
        target_pose.pose.position.z = 0.946136 #table_ground + table_size[2] + target_size[2] / 2.0
        
        target_pose.pose.orientation.x = 0.721655   
        target_pose.pose.orientation.y = -0.68675
        target_pose.pose.orientation.z =-0.0565409
        target_pose.pose.orientation.w = -0.0662693
        ...
        place_pose.pose.position.z = table_ground + table_size[2] + target_size[0] / 2.0
        ...
        grasp_pose.pose.position.y -= target_size[0] / 2.0
